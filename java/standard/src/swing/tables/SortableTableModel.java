...
public class SortableTableModel extends ProxyTableModel {
    ...
    public void sort(int column, Comparator<Object> comparator, boolean ascending) {
        if(comparator == null) {
        ...
        Collections.sort(rows, new TableComparator(comparator, column, ascending));
    ...
    class TableComparator implements Comparator<Object> {
        ...
        public TableComparator(Comparator<Object> comparator, int column, boolean ascending) {
            this.comparator = comparator;
            this.column = column;
            this.ascending = ascending;
        }
