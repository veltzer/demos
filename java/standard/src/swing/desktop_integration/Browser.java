...
public class Browser extends JPanel {
	...
	class ForwardAction extends AbstractAction {
		...
		public ForwardAction() {
            ...
            putValue(SMALL_ICON, new ImageIcon(getClass().getResource("/Forward.png")));
            setEnabled(false);
        }
    ...
    class BackAction extends AbstractAction {
		...
		public BackAction() {
            putValue(NAME, "Back");
            putValue(SMALL_ICON, new ImageIcon(getClass().getResource("/Back.png")));
            setEnabled(false);
        }
        public void actionPerformed(ActionEvent ev) {
            webBrowser.back();
    ...
    private static final ImageIcon BROWSE_ICON = new ImageIcon(Browser.class.getResource("/Right.gif"));
    ...
    public Browser() {
        ...
        JButton refreshButton = new JButton("Refresh", new ImageIcon(getClass().getResource("/Reload.png")));
        ...
        JButton stopButton = new JButton("Stop", new ImageIcon(getClass().getResource("/Stop.png")));
