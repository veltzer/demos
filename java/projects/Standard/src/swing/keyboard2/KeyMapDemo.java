...
public class KeyMapDemo extends JPanel {
    ...
    private final static Action[] UPCASE_ACTIONS = {
            new InsertMeAction("A"),
            new InsertMeAction("B"),
            new InsertMeAction("C"),
            new InsertMeAction("D"),
            new InsertMeAction("E"),
            new InsertMeAction("F"),
            new InsertMeAction("G"),
            new InsertMeAction("H"),
            new InsertMeAction("I"),
            new InsertMeAction("J"),
            new InsertMeAction("K"),
            new InsertMeAction("L"),
            new InsertMeAction("M"),
            new InsertMeAction("N"),
            new InsertMeAction("O"),
            new InsertMeAction("P"),
            new InsertMeAction("Q"),
            new InsertMeAction("R"),
            new InsertMeAction("S"),
            new InsertMeAction("T"),
            new InsertMeAction("U"),
            new InsertMeAction("V"),
            new InsertMeAction("W"),
            new InsertMeAction("X"),
            new InsertMeAction("Y"),
