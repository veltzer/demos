...
/**
 * This is a simple single linked list implemented in java
 * without the aid of the java collection package.
 * 
 * The drawback of this implementation is that order of
 * iteration is different than order of insertion.
 * 
 * @author mark
 */
...
public class SingleLinkedListCorrectIterOrderGeneric<T> {
    ...
    public static void main(String[] args) {
    	SingleLinkedListCorrectIterOrderGeneric<Integer> li=
    			new SingleLinkedListCorrectIterOrderGeneric<Integer>();
    	li.add(45);
    	li.add(23);
    	li.add(75);
    	System.out.println("size of the list is "+li.size());
        SingleLinkedListCorrectIterOrderGeneric.Iterator<Integer> it=li.getIterator();
        while(it.hasNext()) {
