...
public class AddressBookPreferencePage
	...
	public void createFieldEditors() {
		addField(
			new BooleanFieldEditor(
				AddressBookPreferences.P_SHOW_PHONE,
				"Show &Phone numbers section",
				getFieldEditorParent()));

        addField(
            new StringListEditor(
                AddressBookPreferences.P_IM_CLIENT_TYPES,
                "Supported &IM client programs:",
                getFieldEditorParent()));
	}
