...
import com.example.addressbook.view.preferences.*;
 ...
 * </ul>
 */
public class AddressBookEditor extends MultiPageEditorPart implements IResourceChangeListener {
    ...
    void createContactPage() {
        ...
        imClient.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                ...
                imName.getParent().redraw(); // Solve refresh bug in Eclipse 3.1 on XP
            }
        });
    ...
    private void updateContactFromSource() {
        try {
            BufferedReader in = new BufferedReader(new StringReader(getDocumentSource().get()));
