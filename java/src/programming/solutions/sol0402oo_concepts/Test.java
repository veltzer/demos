...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("Customer1 name:"+customer1.getName()+" id:"+customer1.getAccount().getId()+
												" balance:"+customer1.getAccount().getBalance());
		System.out.println("Customer2 name:"+customer2.getName()+" id:"+customer2.getAccount().getId()+
