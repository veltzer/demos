    ...
    public AssociationDemo() {
        ...
        bind.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                try {
                    org.jdesktop.jdic.filetypes.Action action = 
                        new org.jdesktop.jdic.filetypes.Action(associationName.getText(),
        ...
        fileExtension.getDocument().addDocumentListener(new DocumentProxy() {
            protected void update() {
                if(fileExtension.getText().length() > 0) {
                    Association asso = svc.getFileExtensionAssociation(fileExtension.getText());
                    if(asso != null) {
