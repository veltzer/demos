...
public class TotalProxyTableModel extends ProxyTableModel {
    ...
    public TotalProxyTableModel(TableModel model, int totalColumn, int descriptionColumn, String totalString) {
        super(model);
        ...
        if(row == super.getRowCount()) {
            ...
            if(col == totalColumn) {
                ...
                for(int iter = 0 ; iter < row ; iter++) {
                    total = total.add( ((Currency)getValueAt(iter, col)).getValue() );
                }
