...
public class TriangleEtchedBorder extends EtchedBorder {
	...
	public Insets getBorderInsets(Component c) {
        // right now only button is supported since this border needs intimate knowledge of
        // the component structure this is also a very simplified preffered size calculation
        JButton b = (JButton) c;
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        g.drawPolygon(new int[]{0, width - 1, width / 2 - 1}, new int[]{height - 2, height - 2, 0}, 3);
