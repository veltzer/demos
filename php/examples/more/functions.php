...
// it gets as many arguments as you'll send. You cant see that from
// the method signature, however. It uses support functions from PHP
// in order to gain access to all of the arguments passed to it, it
// then consider them, consider some of them or disregard them.
function multiadd() {
