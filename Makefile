...
check_extra_files:
	find -type f -and -not -name "*.cc" -and -not -name "*.h" -and -not -name "*.c" -and -not -name "Makefile" -and -not -name "*.txt" -and -not -path "./.git/*" -and -not -name "*.sed" -and -not -name "*.patch" -and -not -name "*.mk"
